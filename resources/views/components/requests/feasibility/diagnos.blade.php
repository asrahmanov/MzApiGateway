...
<ul class="nav nav-tabs" id="diagnosTabs" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="diagnos_tab1" data-toggle="tab" href="#diagnos1" role="tab" aria-controls="diagnos1" aria-selected="true">diagnos1</a>
    </li>
    <li id="new_tab_diagnosis" class="nav-item">
        <a  class="nav-link disabled" data-toggle="tab" href="#" role="tab" aria-controls="disabled" aria-selected="false">+</a>
    </li>
</ul>
<div class="tab-content border border-top-0 p-3" id="diagnosTabsContent">
    <div class="tab-pane fade show active" id="diagnos1" role="tabpanel" aria-labelledby="diagnos1-tab">
        <div class="form-group">
            <label>Indication/diagnosis</label>
            <select class="js-example-basic-multiple w-100"  id="disease1" name="diagnos[1][disease]">
