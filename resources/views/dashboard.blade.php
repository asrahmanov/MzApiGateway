                    ...
                    <div class="cover">
                        ...
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="profile-name">{{session('user')['first_name']}} {{session('user')['last_name']}}</span>
                            </div>
            ...
            <div class="d-none d-md-block col-md-4 col-xl-3 left-wrapper">
                <div class="card rounded">
                    <div class="card-body">
                        ...
                        <p>Hi! I'm Amiah the Senior UI Designer at Aleksey Rakhmanov. We hope you enjoy the design and quality of Social.</p>
                        <div class="mt-3">
