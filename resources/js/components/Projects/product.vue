<template>
    <div>
        <div class="row">
            <div class="col-4">
                <label>Фильтр:</label>
                <input v-model="searchTerm" @keyup="doSearch"  class="form-control mb-3"/>
            </div>
        ...
        const table = reactive({
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: true,
                    display: function (row) {
                        return (`<a href="../../project/info/${row.id}" target="_blank" class="btn btn-success">Карточка продукта</a>`);
                    },
                },
            ],
            rows: [],
            ...
            .then(response => {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        let uId = props.user_id, url = uId === 1 ? "../project/getProjectAll" : `../project/getProjectByUser/${props.user_id}`;
                        axios.get(url)
                            .then(response => {
                                table.rows = [];
                                response.data.forEach(row => {
