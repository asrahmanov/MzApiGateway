<template>
    ...
    <div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" @input="event => first_name = validateStr(event.target.value)" v-model="first_name" autocomplete="off"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" @input="event => last_name = validateStr(event.target.value)" placeholder="Фамилия" v-model="last_name" v-else>
        </div>
